...
{
    public class MockSamochodRepository : ISamochodRepository       //implementujemy interfejs ISamochodRepository
    {                                                               // i ppm "implementuj interfejs"
        private List<Samochod> samochody;               //tworzymy prywatną listę samochodów

        public MockSamochodRepository()
        {
            if (samochody == null)                    //inicjujemy liste samochodów gdy pusta
            {
                ZaladujSamochody();                    //generujemy metode ZaladujSamochody
            }
        }
